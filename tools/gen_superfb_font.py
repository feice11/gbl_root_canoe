...
CJK += "初打管后化继接理连脑使始态续状"
UI_ROOTS = [
    ROOT / "submodules/uefi/edk2/QcomModulePkg/Application/LinuxLoader",
    ROOT / "submodules/uefi/edk2/QcomModulePkg/Library/FastbootLib",
    ROOT / "submodules/uefi/edk2/AndroidToolsPkg",
]
UI_SOURCES = sorted(
    source
    for ui_root in UI_ROOTS
    for source in ui_root.rglob("*")
    if source.suffix in {".c", ".h"} and source.name != "SuperFbFont.h"
)
